...
class CommandRouter:
    ...
    def route_command(self,
        ...
        extraction_failure_workflow = (
            None if "parameter_extraction" in self._session.workflow_folderpath
        ...
        if abort_command:
            return CommandOutput(success=False, response=f"Command aborted", payload={"abort_command": True})
