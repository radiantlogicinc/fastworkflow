...
from fastworkflow.workflow import Workitem, Workflow
...
class Session:
    ...
    def __init__(self, session_id: int, workflow_folderpath: str):
        ...
        self._command_routing_definition = CommandRoutingDefinition.create(workflow_folderpath)
        self._utterance_definition = UtteranceDefinition.create(workflow_folderpath)

        self._workflow = Workflow(workflow_definition=self._workflow_definition, 
    ...
    def get_contextdb_folderpath(self, session_id: int) -> str:
        ...
        return os.path.join(self._workflow_folderpath, SPEEDDICT_FOLDERNAME, session_id_str)

    def get_cachedb_folderpath(self, function_name: str) -> str:
        """Get the cache database folder path for a specific function"""
        return os.path.join(self._workflow_folderpath, SPEEDDICT_FOLDERNAME, 
