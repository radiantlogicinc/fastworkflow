...
#         domain_description: Description of the domain for which examples should be generated
...
#     - Optional parameters should sometimes be None (absent) in the examples
...
#     # Call the model to generate examples
#     response = client.chat.completions.create(
#         model=model,
#         max_tokens=4000,
#         temperature=temperature,
#         system="You are a synthetic data generator. Generate realistic and diverse examples in the exact format requested.",
#         messages=[
