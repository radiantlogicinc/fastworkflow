...
class Signature:
    class Input(BaseModel):
        workitem_path: Optional[str] = Field(
            default="",
            description="The path of the workitem to move to.",
            examples=["/a/b/c"],
        )
    ...
    def generate_utterances(session: Session, command_name: str) -> list[str]:
        ...
        for input in inputs:
            kwargs = {field: getattr(input, field) for field in Signature.Input.model_fields}
